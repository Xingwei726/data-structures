...
// create a list of meetings here, populate that list for each row of data, then add it to the database after you process everything
// [
// {meeting1 info without a key},
// {meeting2 info}
// ]
var meetingList = [];
var meetings = {};

let html = fs.readFileSync('/home/ec2-user/environment/week1/m09.txt');
let $ = cheerio.load(html);
// LOAD FILE TO CHEERIO
// // fs.readFileSync('/home/ec2-user/environment/week1/m09.txt', 'utf8', (error, data) => {
...
fs.writeFileSync('testnew.json',write);


function getGeocode(name, address) {
    console.log(address.streetInfo);
